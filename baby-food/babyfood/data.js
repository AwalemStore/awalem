const APP_DATA = {
    ...
    dict: {
        ar: { printTitle: "خطة غذاء الطفل (6 أشهر)", week: "الأسبوع", prep: "طريقة التحضير", track: "تتبع الحساسية", day: "يوم", alt: "بديل", ing: "المكونات", step: "التحضير", swap: "تبديل", reaction: "تفاعل الطفل", notes: "ملاحظات", done: "تم التقديم", markDone: "تم التقديم؟", progress: "التقدم", childName: "اسم الطفل/الطفلة", childDob: "تاريخ ميلاد الطفل", startDate: "تاريخ البدء", lang: "لغة المساعدة", generate: "عرض خطة الـ 6 أشهر", loginTitle: "تغذية طفلك", loginSub: "أدخلي رقم الجوال المسجل في طلبك للدخول إلى منصتك", phone: "رقم الجوال", loginBtn: "تسجيل الدخول", print: "طباعة الجدول", sendMail: "إرسال بالبريد", whatsapp: "واتساب", forbidden: "أطعمة محظورة تماماً (قبل عمر السنة)", tips: "نصائح عوالم", rules: "قواعد التغذية الطبية السليمة", references: "المراجع الطبية", footer: "صنع من قبل عوالم Awalem", stage: "المرحلة", months: "أشهر", ageNow: "عمر الطفل الآن", enterData: "الرجاء إدخال", loginFirst: "يرجى تسجيل الدخول أولاً", threeDayRule: "قاعدة الـ 3 أيام", noSalt: "يُمنع منعاً تاماً إضافة الملح والسكر والعسل قبل عمر السنة", startSmall: "ابدأي بملعقة واحدة إلى ملعقتين يومياً في البداية", allergicNote: "سجّلي ردة فعل طفلكِ لكل طعام جديد" },
        en: { printTitle: "Baby Meal Plan (6 Months)", week: "Week", prep: "Recipe", track: "Track", day: "Day", alt: "Swap", ing: "Ingredients", step: "Steps", swap: "Swap", reaction: "Baby's Reaction", notes: "Notes", done: "Done", markDone: "Mark Done", progress: "Progress", childName: "Child's Name", childDob: "Date of Birth", startDate: "Start Date", lang: "Helper Language", generate: "Generate 6-Month Plan", loginTitle: "Baby Nutrition", loginSub: "Enter your registered phone number", phone: "Phone Number", loginBtn: "Login", print: "Print Schedule", sendMail: "Send Email", whatsapp: "WhatsApp", forbidden: "Forbidden Foods (Under 1 Year)", tips: "Tips", rules: "Feeding Rules", references: "Medical References", footer: "Made by Awalem", stage: "Stage", months: "months", ageNow: "Child's age now", enterData: "Please enter", loginFirst: "Please login first", threeDayRule: "3-Day Rule: One new food every 3 days", noSalt: "No salt, sugar, or honey before age 1", startSmall: "Start with 1-2 teaspoons daily", allergicNote: "Record baby's reaction to each new food" },
        tl: { printTitle: "Plano ng Pagkain (6 Buwan)", week: "Linggo", prep: "Resipe", track: "Tala", day: "Araw", alt: "Palitan", ing: "Mga Sangkap", step: "Mga Hakbang", swap: "Palitan", reaction: "Reaksyon ng Sanggol", notes: "Mga Tala", done: "Tapos na", markDone: "Tapos na?", progress: "Pag-unlad", childName: "Pangalan ng Bata", childDob: "Petsa ng Kapanganakan", startDate: "Petsa ng Simula", lang: "Wika ng Tulong", generate: "Gumawa ng 6-Buang Plano", loginTitle: "Nutrisyon ng Sanggol", loginSub: "Ilagay ang nakarehistrong numero ng telepono", phone: "Numero ng Telepono", loginBtn: "Mag-login", print: "I-print", sendMail: "Magpadala ng Email", whatsapp: "WhatsApp", forbidden: "Ipinagbabawal na Pagkain (Wala pang 1 Taon)", tips: "Mga Tip", rules: "Mga Patakaran", references: "Mga Sanggunian", footer: "Gawa ng Awalem", stage: "Yugto", months: "buwan", ageNow: "Edad ng bata ngayon", enterData: "Pakilagay", loginFirst: "Mag-login muna", threeDayRule: "3-Araw na Patakaran", noSalt: "Bawal ang asin, asukal, at pulot bago mag-1 taon", startSmall: "Magsimula sa 1-2 kutsarita araw-araw", allergicNote: "I-record ang reaksyon ng sanggol" },
        id: { printTitle: "Rencana Makan (6 Bulan)", week: "Minggu", prep: "Resep", track: "Lacak", day: "Hari", alt: "Ganti", ing: "Bahan", step: "Langkah", swap: "Ganti", reaction: "Reaksi Bayi", notes: "Catatan", done: "Selesai", markDone: "Tandai Selesai", progress: "Kemajuan", childName: "Nama Anak", childDob: "Tanggal Lahir", startDate: "Tanggal Mulai", lang: "Bahasa", generate: "Buat Rencana 6 Bulan", loginTitle: "Nutrisi Bayi", loginSub: "Masukkan nomor telepon terdaftar", phone: "Nomor Telepon", loginBtn: "Masuk", print: "Cetak", sendMail: "Kirim Email", whatsapp: "WhatsApp", forbidden: "Makanan Terlarang (Di Bawah 1 Tahun)", tips: "Tips", rules: "Aturan Makan", references: "Referensi Medis", footer: "Dibuat oleh Awalem", stage: "Tahap", months: "bulan", ageNow: "Usia anak sekarang", enterData: "Silakan masukkan", loginFirst: "Silakan login terlebih dahulu", threeDayRule: "Aturan 3 Hari", noSalt: "Tanpa garam, gula, dan madu sebelum 1 tahun", startSmall: "Mulai dengan 1-2 sendok teh per hari", allergicNote: "Catat reaksi bayi terhadap makanan baru" },
        hi: { printTitle: "शिशु आहार योजना", week: "सप्ताह", prep: "विधि", track: "ट्रैक", day: "दिन", alt: "बदलें", ing: "सामग्री", step: "तरीका", swap: "बदलें", reaction: "शिशु की प्रतिक्रिया", notes: "नोट्स", done: "हो गया", markDone: "पूरा करें?", progress: "प्रगति", childName: "बच्चे का नाम", childDob: "जन्म तिथि", startDate: "आरंभ तिथि", lang: "सहायक भाषा", generate: "6 महीने की योजना बनाएं", loginTitle: "शिशु पोषण", loginSub: "पंजीकृत फ़ोन नंबर दर्ज करें", phone: "फ़ोन नंबर", loginBtn: "लॉगिन", print: "प्रिंट करें", sendMail: "ईमेल भेजें", whatsapp: "व्हाट्सएप", forbidden: "प्रतिबंधित खाद्य पदार्थ", tips: "सुझाव", rules: "खिलाने के नियम", references: "चिकित्सा संदर्भ", footer: "Awalem द्वारा निर्मित", stage: "चरण", months: "महीने", ageNow: "बच्चे की उम्र", enterData: "कृपया दर्ज करें", loginFirst: "कृपया पहले लॉगिन करें", threeDayRule: "3 दिन का नियम", noSalt: "1 साल से पहले नमक, चीनी और शहद न दें", startSmall: "रोज़ 1-2 चम्मच से शुरू करें", allergicNote: "शिशु की प्रतिक्रिया दर्ज करें" },
        ur: { printTitle: "بچے کی خوراک کا منصوبہ", week: "ہفتہ", prep: "ترکیب", track: "ٹریک", day: "دن", alt: "تبدیل", ing: "اجزاء", step: "طریقہ", swap: "تبدیل", reaction: "بچے کا ردعمل", notes: "نوٹس", done: "ہو گیا", markDone: "مکمل کریں؟", progress: "ترقی", childName: "بچے کا نام", childDob: "تاریخ پیدائش", startDate: "شروع کی تاریخ", lang: "مدد کی زبان", generate: "6 مہینوں کا منصوبہ بنائیں", loginTitle: "بچے کی خوراک", loginSub: "اپنا رجسٹرڈ فون نمبر درج کریں", phone: "فون نمبر", loginBtn: "لاگ ان", print: "پرنٹ کریں", sendMail: "ای میل بھیجیں", whatsapp: "واٹس ایپ", forbidden: "ممنوعہ غذائیں", tips: "تجاویز", rules: "کھلانے کے اصول", references: "طبی حوالے", footer: "Awalem کی طرف سے", stage: "مرحلہ", months: "مہینے", ageNow: "بچے کی عمر", enterData: "براہ کرم درج کریں", loginFirst: "پہلے لاگ ان کریں", threeDayRule: "3 دن کا اصول", noSalt: "1 سال سے پہلے نمک، چینی اور شہد نہ دیں", startSmall: "روزانہ 1-2 چائے کے چمچ سے شروع کریں", allergicNote: "بچے کا ردعمل درج کریں" },
        bn: { printTitle: "শিশু আহার পরিকল্পনা", week: "সপ্তাহ", prep: "রেসিপি", track: "ট্র্যাক", day: "দিন", alt: "পরিবর্তন", ing: "উপকরণ", step: "পদ্ধতি", swap: "পরিবর্তন", reaction: "শিশুর প্রতিক্রিয়া", notes: "নোটস", done: "সম্পন্ন", markDone: "সম্পন্ন করুন?", progress: "অগ্রগতি", childName: "শিশুর নাম", childDob: "জন্ম তারিখ", startDate: "শুরুর তারিখ", lang: "সাহায্যকারী ভাষা", generate: "6 মাসের পরিকল্পনা তৈরি করুন", loginTitle: "শিশু পুষ্টি", loginSub: "নিবন্ধিত ফোন নম্বর দিন", phone: "ফোন নম্বর", loginBtn: "লগইন", print: "প্রিন্ট করুন", sendMail: "ইমেইল পাঠান", whatsapp: "হোয়াটসঅ্যাপ", forbidden: "নিষিদ্ধ খাবার", tips: "পরামর্শ", rules: "খাওয়ার নিয়ম", references: "চিকিৎসা সংস্থান", footer: "Awalem দ্বারা নির্মিত", stage: "পর্যায়", months: "মাস", ageNow: "শিশুর বয়স", enterData: "দয়া করে লিখুন", loginFirst: "প্রথমে লগইন করুন", threeDayRule: "3 দিনের নিয়ম", noSalt: "1 বছরের আগে লবণ, চিনি ও মধু দেবেন না", startSmall: "প্রতিদিন 1-2 চামচ দিয়ে শুরু করুন", allergicNote: "শিশুর প্রতিক্রিয়া লিখুন" },
        si: { printTitle: "ළදරු ආහාර සැලැස්ම", week: "සතිය", prep: "වට්ටෝරුව", track: "පරීක්ෂාව", day: "දිනය", alt: "මාරු කරන්න", ing: "අමුද්‍රව්‍ය", step: "පියවර", swap: "මාරු කරන්න", reaction: "ළදරු ප්‍රතිචාරය", notes: "සටහන්", done: "අවසන්", markDone: "සලකුණු කරන්න?", progress: "ප්‍රගතිය", childName: "ළදරුවාගේ නම", childDob: "උපන් දිනය", startDate: "ආරම්භ දිනය", lang: "උපකාරක භාෂාව", generate: "6 සති සැලැස්ම", loginTitle: "ළදරු පෝෂණය", loginSub: "ලියාපදිංචි දුරකථන අංකය ඇතුලත් කරන්න", phone: "දුරකථන අංකය", loginBtn: "පුරනය", print: "මුද්‍රණය", sendMail: "ඊමේල් යවන්න", whatsapp: "වොට්සැප්", forbidden: "තහනම් ආහාර", tips: "උපදෙස්", rules: "ආහාර රීති", references: "වෛද්‍ය යොමු", footer: "Awalem විසින් නිර්මාණය", stage: "අදියර", months: "මාස", ageNow: "ළදරුවාගේ වයස", enterData: "කරුණාකර ඇතුලත් කරන්න", loginFirst: "කරුණාකර පුරනය වන්න", threeDayRule: "3 දින නීතිය", noSalt: "1 වසරට පෙර ලුණු, සීනි සහ මී පැණි නොදෙන්න", startSmall: "දිනපත් 1-2 තේ හැන්දකින් ආරම්භ කරන්න", allergicNote: "ළදරුවාගේ ප්‍රතිචාරය සටහන් කරන්න" },
        ne: { printTitle: "शिशु भोजन योजना", week: "हप्ता", prep: "विधि", track: "ट्र्याक", day: "दिन", alt: "बदल्नुहोस्", ing: "सामग्री", step: "तरिका", swap: "बदल्नुहोस्", reaction: "शिशुको प्रतिक्रिया", notes: "नोटहरू", done: "भयो", markDone: "पूरा गर्नुहुन्छ?", progress: "प्रगति", childName: "बच्चाको नाम", childDob: "जन्म मिति", startDate: "सुरु मिति", lang: "सहायक भाषा", generate: "6 हप्ताको योजना बनाउनुहोस्", loginTitle: "शिशु पोषण", loginSub: "दर्ता भएको फोन नम्बर हाल्नुहोस्", phone: "फोन नम्बर", loginBtn: "लगइन", print: "प्रिन्ट गर्नुहोस्", sendMail: "इमेल पठाउनुहोस्", whatsapp: "व्हाट्सएप", forbidden: "निषेधित खाना", tips: "सुझाव", rules: "खुवाउने नियम", references: "चिकित्सा सन्दर्भ", footer: "Awalem द्वारा निर्मित", stage: "चरण", months: "महिना", ageNow: "बच्चाको उमेर", enterData: "कृपया हाल्नुहोस्", loginFirst: "पहिले लगइन गर्नुहोस्", threeDayRule: "3 दिनको नियम", noSalt: "1 वर्ष अघि नुन, चिनी र मह नदिनुहोस्", startSmall: "दैनिक 1-2 चम्चाले सुरु गर्नुहोस्", allergicNote: "शिशुको प्रतिक्रिया रेकर्ड गर्नुहोस्" },
        am: { printTitle: "የህፃን ምግብ እቅድ", week: "ሳምንት", prep: "አሰራር", track: "ክትትል", day: "ቀን", alt: "ቀይር", ing: "ግብአቶች", step: "ደረጃዎች", swap: "ቀይር", reaction: "የህፃኑ ምላሽ", notes: "ማስታወሻዎች", done: "ተጠናቀቀ", markDone: "ምልክት አድርግ?", progress: "እድገት", childName: "የህፃኑ ስም", childDob: "የልደት ቀን", startDate: "የመጀመሪያ ቀን", lang: "የረዳት ቋንቋ", generate: "6 ሳምንት እቅድ ፍጠር", loginTitle: "የህፃን ስርአተ ምግብ", loginSub: "የተመዘገበ ስልክ ቁጥር ያስገቡ", phone: "ስልክ ቁጥር", loginBtn: "ግባ", print: "አትም", sendMail: "ኢሜል ላክ", whatsapp: "ዋትስአፕ", forbidden: "ከበሉ የተከለከሉ ምግቦች", tips: "ምክሮች", rules: "የመመገቢያ ህጎች", references: "የህክምና ማመዛዘኛ", footer: "በAwalem የተሰራ", stage: "ደረጃ", months: "ወራት", ageNow: "የህፃኑ ዕድሜ", enterData: "እባክዎ ያስገቡ", loginFirst: "እባክዎ መጀመሪያ ይግቡ", threeDayRule: "3 ቀን ህግ", noSalt: "ከ1 ዓመት በፊት ጨው፣ ስኳር እና ማር አይስጡ", startSmall: "በቀን 1-2 ማንኪያ ይጀምሩ", allergicNote: "የህፃኑን ምላሽ ያስፈርሙ" },
        sw: { printTitle: "Mpango wa Chakula", week: "Wiki", prep: "Mapishi", track: "Fuatilia", day: "Siku", alt: "Badilisha", ing: "Viungo", step: "Hatua", swap: "Badilisha", reaction: "Mwitiko wa Mtoto", notes: "Vidokezo", done: "Imekamilika", markDone: "Weka alama?", progress: "Maendeleo", childName: "Jina la Mtoto", childDob: "Tarehe ya Kuzaliwa", startDate: "Tarehe ya Kuanza", lang: "Lugha ya Msaada", generate: "Tengeneza Mpango wa Miezi 6", loginTitle: "Lishe ya Mtoto", loginSub: "Ingiza nambari yako ya simu", phone: "Nambari ya Simu", loginBtn: "Ingia", print: "Chapisha", sendMail: "Tuma Barua Pepe", whatsapp: "WhatsApp", forbidden: "Vyakula Vilivyokatazwa", tips: "Vidokezo", rules: "Sheria za Kulisha", references: "Vyanzo vya Matibabu", footer: "Imetengenezwa na Awalem", stage: "Hatua", months: "miezi", ageNow: "Umri wa mtoto sasa", enterData: "Tafadhali ingiza", loginFirst: "Tafadhali ingia kwanza", threeDayRule: "Sheria ya Siku 3", noSalt: "Hakuna chumvi, sukari au asali kabla ya mwaka 1", startSmall: "Anza na vijiko 1-2 kila siku", allergicNote: "Rekodi mwitiko wa mtoto" },
        om: { printTitle: "Qqox xiqxaa", week: "Torban", prep: "Haawa", track: "Hordoffii", day: "Bara", alt: "Jijjiiri", ing: "Wantoota", step: "Tarkaanfii", swap: "Jijjiiri", reaction: "Deebii mucaa", notes: "Yaadota", done: "Xumurame", markDone: "Mallattoo?", progress: "Adeemsa", childName: "Maqaa mucaa", childDob: "Guyyaa dhaloota", startDate: "Guyyaa jalqabaa", lang: "Afaan gargaarsaa", generate: "Qqox xiqxaa ji'a 6", loginTitle: "Nyaata mucaa", loginSub: "Lakkoofsa bilbilaa galchii", phone: "Lakkoofsa bilbilaa", loginBtn: "Seeni", print: "Maxxansi", sendMail: "Imeel ergi", whatsapp: "WhatsApp", forbidden: "Nyaata dhorkamtootaa", tips: "Gorsa", rules: "Seera nyaataa", references: "Fuula yaalaa", footer: "Awalem tiin hojjetame", stage: "Saffisa", months: "ji'a", ageNow: "Umurri mucaa amma", enterData: "Maaloo galchii", loginFirst: "Maaloo jalqaba seeni", threeDayRule: "Seera guyyaa 3", noSalt: "Qumbii, suukara fi dhadhaa jaarraa 1 dura hin kennitu", startSmall: "Guyyaatti foonii 1-2 irraa jalqabi", allergicNote: "Deebii mucaa galmeessi" },
        lg: { printTitle: "Pulogulaamu ya'enywa", week: "Esanga", prep: "Okufumba", track: "Okulondoola", day: "Olunaku", alt: "Kyusa", ing: "Ebikozeso", step: "Entegeka", swap: "Kyusa", reaction: "Endabika ya'omwana", notes: "Ebikwatako", done: "Kimalidde", markDone: "Laga?", progress: "Yitangira", childName: "Erinnya lya'omwana", childDob: "Olunaku lwa'okuzalibwa", startDate: "Olunaku lwa'okutandika", lang: "Olulimi oluyambi", generate: "Pulogulaamu emyezi 6", loginTitle: "Emmere ya'omwana", loginSub: "Teeka namba ya ssimu", phone: "Namba ya ssimu", loginBtn: "Yingira", print: "Fulumya", sendMail: "Wangaaka imeeyo", whatsapp: "WhatsApp", forbidden: "Emmere evunze", tips: "Okuyamba", rules: "Amateeka g'okuliisa", references: "Ebiwandiiko by'obujjanjabi", footer: "Ekoleddwa Awalem", stage: "Omutendera", months: "Emyezi", ageNow: "Emyaka gya'omwana kati", enterData: "Mpolampola teeka", loginFirst: "Mpolampola yingira", threeDayRule: "Amateeka ga'lunaku 3", noSalt: "Tte, sukaali na mubisi omwaka 1 tetugenda", startSmall: "Ntandika ne kijja 1-2 buli lunaku", allergicNote: "Londoola endabika ya'omwana" },
        so: { printTitle: "Qorshaha cuntada", week: "Toddobaad", prep: "Habka", track: "La soco", day: "Maalin", alt: "Bedel", ing: "Maado", step: "Tallaabo", swap: "Bedel", reaction: "Radjmac ilmaha", notes: "Fikro", done: "Dhammaaday", markDone: "Calaamad?", progress: "Hagaajin", childName: "Magaca ilmaha", childDob: "Taariikhda dhalashada", startDate: "Taariikhda bilaabid", lang: "Luuqadda caawinta", generate: "Samee qorshe 6 bilood", loginTitle: "Nafaqada ilmaha", loginSub: "Geli lambarka telefoonka", phone: "Lambarka telefoonka", loginBtn: "Geli", print: "Daabac", sendMail: "Iimeel dir", whatsapp: "WhatsApp", forbidden: "Cunto la mamnuucay", tips: "Talo", rules: "Sharciyada cuntada", references: "Xogta caafimaadka", footer: "Laga sameeyay Awalem", stage: "Heerka", months: "Bilaha", ageNow: "Da'da ilmaha hadda", enterData: "Fadlan geli", loginFirst: "Fadlan horay u geli", threeDayRule: "Xeerka maalinta 3", noSalt: "Milix, sonkor iyo shaha sanadka 1 ka hor ha siin", startSmall: "Bilow boqol-mito 1-2 maalintii", allergicNote: "Diiwaan geli radjmac ilmaha" },
        fr: { printTitle: "Plan alimentaire", week: "Semaine", prep: "Recette", track: "Suivi", day: "Jour", alt: "Remplacer", ing: "Ingredients", step: "Etapes", swap: "Remplacer", reaction: "Reaction du bebe", notes: "Notes", done: "Fait", markDone: "Fait?", progress: "Progres", childName: "Nom de l'enfant", childDob: "Date de naissance", startDate: "Date de debut", lang: "Langue", generate: "Generer plan 6 mois", loginTitle: "Nutrition bebe", loginSub: "Entrez votre numero de telephone", phone: "Telephone", loginBtn: "Connexion", print: "Imprimer", sendMail: "Envoyer email", whatsapp: "WhatsApp", forbidden: "Aliments interdits", tips: "Conseils", rules: "Regles alimentaires", references: "References medicales", footer: "Fait par Awalem", stage: "Etape", months: "mois", ageNow: "Age du bebe", enterData: "Veuillez entrer", loginFirst: "Veuillez vous connecter", threeDayRule: "Regle des 3 jours", noSalt: "Pas de sel, sucre ni miel avant 1 an", startSmall: "Commencer avec 1-2 cuilleres par jour", allergicNote: "Noter la reaction du bebe" }
    },
    ...
    stages: {
        ...
        8: {
            title: "المرحلة الثالثة: تنويع النكهات والقوام المتوسط",
            icon: "🥗",
            description: "دمج المكونات وتقديم وجبات مركبة مع الحفاظ على القوام اللين",
            weeks: [
                [
                    { name: "أرز مهروس بالخضار", icon: "🍚", prep: "طهي الأرز حتى يصبح ليناً جداً ثم هرسه مع جزر وكوسة مسلوقة.", alt: "برغل مهروس بالخضار." },
                    { name: "تفاح وجزر مهروس", icon: "🥕", prep: "سلق التفاح والجزر معاً ثم هرسهما للحصول على مزيج حلو ولين.", alt: "يقطين وتفاح مهروس." }
                ],
                [
                    { name: "دجاج مع بطاطس", icon: "🍗", prep: "سلق الدجاج والبطاطس معاً ثم هرسهما بالمرق لقوام كريمي.", alt: "لحم مفروم مع بطاطس مهروسة." },
                    { name: "شوفان بالموز", icon: "🍌", prep: "طهي الشوفان المطحون ثم إضافة موز مهروس وقليل من حليب الأم.", alt: "شوفان بتفاح مهروس." }
                ],
                [
                    { name: "عدس وجزر", icon: "🍲", prep: "سلق العدس مع الجزر حتى يذوب تماماً ثم هرسه لقوام ناعم.", alt: "عدس مع كوسة مهروسة." },
                    { name: "زبادي بفواكه", icon: "🥛", prep: "خلط زبادي طبيعي كامل الدسم مع موز أو تفاح مهروس.", alt: "زبادي بخوخ مهروس." }
                ],
                [
                    { name: "خضار مختلطة مهروسة", icon: "🥦", prep: "سلق مزيج من البروكلي والجزر والكوسة ثم هرسها معاً.", alt: "سبانخ وبطاطس مهروسة." },
                    { name: "سمك أبيض بالبطاطا", icon: "🐟", prep: "سلق سمك أبيض خالٍ من الأشواك مع بطاطا حلوة ثم هرسهما.", alt: "سمك مع أرز مهروس." }
                ]
            ]
        },
        9: {
        ...
        10: {
            title: "المرحلة الخامسة: تشجيع الأكل الذاتي",
            icon: "🤲",
            description: "أطعمة بقطع أكبر يشجع الطفل على الإمساك والأكل بنفسه مع تنويع المصادر الغذائية",
            weeks: [
                [
                    { name: "أصابع الدجاج", icon: "🍗", prep: "تقطيع صدور الدجاج المسلوقة إلى أصابع طولية يستطيع الطفل إمساكها.", alt: "أصابع سمك مشوية." },
                    { name: "أصابع البطاطا المشوية", icon: "🍠", prep: "تقطيع البطاطا الحلوة لأصابع وشويها حتى تلين تماماً.", alt: "أصابع جزر مشوية." }
                ],
                [
                    { name: "معكرونة بالجبن", icon: "🍝", prep: "سلق معكرونة صغيرة (بيني أو عجلة) ثم خلطها بجبن مبستر مذاب.", alt: "أرز بالزبادي." },
                    { name: " مكعبات الأفوكادو", icon: "🥑", prep: "تقطيع أفوكادو ناضج جداً إلى مكعبات صغيرة لينة.", alt: "موز مقطع شرائح." }
                ],
                [
                    { name: "كفتة دجاج", icon: "🥩", prep: "تحضير كفتة من دجاج مفروم مع شوفان مطحون وشويها بدون ملح.", alt: "كفتة لحم عجل مشوية." },
                    { name: "سلطة خضار ناعمة", icon: "🥗", prep: "تقطيع خيار وطماطم مقشرة وزيتون منزوع النواة لمكعبات صغيرة جداً.", alt: "خضار مسلوقة ومقطعة." }
                ],
                [
                    { name: "بانكيك الشوفان", icon: "🥞", prep: "تحضير بانكيك من شوفان وموز وبيض بدون سكر أو ملح.", alt: "وافل الشوفان بالتفاح." },
                    { name: "شوربة عدس بالخضار", icon: "🍲", prep: "شوربة عدس مطبوخة مع جزر وبطاطس وبروكلي بقطع صغيرة.", alt: "شوربة خضار بالدجاج." }
                ]
            ]
        },
        11: {
            title: "المرحلة السادسة: طعام العائلة المعتاد",
            icon: "👨‍👩‍👧‍👦",
            description: "الطفل يستطيع تناول معظم أطعمة العائلة مع مراعاة عدم الإفراط في الملح والسكر",
            weeks: [
                [
                    { name: "أرز مطبوخ مع خضار", icon: "🍚", prep: "أرز مطبوخ بقوام لين مع خضار مسلوقة ومقطعة صغير.", alt: "برغل مطبوخ." },
